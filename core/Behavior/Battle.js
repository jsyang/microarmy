// Non-shorthand Battle behaviors /////////////////////////////////////
define([
    'core/$'
], function($) {
    var makeBattleBehaviors = function(battleInstance) {
      // todo : make sure this works
      var world = battleInstance._.world;
          ...
          if($.r()<0.011) {
            ...
            if(_.attention.length==2) {
              ...
              Behavior.Custom.createSquad.call(this,
                ...
                [MissileRack,MissileRackSmall,MineFieldSmall,AmmoDumpSmall][$.R(0,3)]
              );
            }
          }
        },
      ...
      return BattleBehaviors;
    };

    return makeBattleBehaviors;
});